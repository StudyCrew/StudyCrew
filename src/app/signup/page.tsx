  ...
  return (
    <div className='flex max-h-full w-full gap-10'>
      <div className="flex flex-col w-[40%] rounded-lg bg-primary-700 px-[46px] py-[70px] gap-20">
        ...
        <h2 className='text-white fontFamily-rubik leading-none text-[45px]'>Elevate Your Learning Experience with a Few Clicks.</h2>
        ...
        <span className="text-white text-[22px] fontFamily-dmSans italic underline">info@studycrew.world</span>
      </div>
      <div className="flex flex-col justify-center pr-100">
        ...
        <p className="text-[22px] mt-3">
          ...
          <Link href="/login" className="text-primary-500 underline">Log in</Link>
        </p>
        ...
        <form className="flex flex-col mt-[20px] gap-[20px]">
          ...
          <div>
            ...
            <label htmlFor="terms" className='pl-2'>I am 16 years or older</label>
          </div>
          <div>
            <input type="checkbox" id="age" name="age" required />
            <label htmlFor="terms" className='pl-2'>I have read and agree to studycrew.world’s {" "} 
              <span className="text-primary-500 underline">Terms and Conditions {" "}</span> and {" "}
              <span className="text-primary-500 underline">Privacy Policy.</span>
            </label>
          </div>
          <Button
            formAction={signup}
