      ...
      <div className="bg-gradient-to-r from-primary-500 to-gradient-500 h-full relative flex flex-col justify-center z-10 md:top-[125px] top-[110px]">
        <div className="mx-32 grid grid-cols-2 mt-32 gap-16 align-center">
          <div className="flex justify-center md:justify-start mb-8">
            <div>
              <h3 className="text-zircon-50 text-xl font-semibold">OUR MISSION</h3>
              ...
              <p className="text-white">
                ...
                open-source online learning platform. This platform will support students on their learning journey and empower them to exploretheir passions together. Our vision is to provide every student with the resources and community they need to achieve their full potential.
              </p>
            </div>
          </div>
