...
import LeftLeaves from "../../../../../public/assets/sign-up/left_leaves.svg"
import RightLeaves from "../../../../../public/assets/sign-up/right_leaves.svg"
  ...
  return (
    <div className="empower">
      <div className="left-wing">
        {/* <Image src="./assets/sign-up/left_leaves.svg" alt="left leaves" className="w-230 h-500"/> */}
      </div>
      ...
      <div className="right-wing">
        {/* <Image src="./assets/sign-up/right_leaves.svg" alt="right leaves" className="w-230 h-500" /> */}
      </div>
    </div>
  )
}
