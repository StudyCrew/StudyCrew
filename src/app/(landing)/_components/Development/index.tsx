    ...
    <div className="md:mx-32 mx-7">
      ...
      <div className="flex flex-col mt-8">
        <DevelopmentCard title="Joining the Community" icon={UsersThree}>
          ...
          <a
            href="https://discord.gg/fxd6uHbdBt"
            className="underline"
            target="_blank"
          >
            Discord server
        ...
        <DevelopmentCard title="Working on an Issue" icon={Code}>
          Once an issue is assigned, work can begin by creating a new branch on
        ...
        <DevelopmentCard
          ...
          last={true}
        >
          Once an issue is completed, a pull request can be submitted for prompt
          review by our maintainers.
        </DevelopmentCard>
      </div>
    </div>
  )
