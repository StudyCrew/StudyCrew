...
const Dropdown: React.FC<DropdownProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`currentchoice flex py-2 px-2 text-xl w-fit border-2 border-[#E5E5E5] ${opened ? 'rounded-t-[6px]' : 'rounded-[6px]'}`}
      >
      ...
      {opened && (
        <div
          className="w-[332px] bg-[#f3f4f8] absolute top-[46px] rounded rounded-b-[6px] p-2 flex flex-col"
          style={{ fontFamily: 'DM Sans, sans-serif' }}
        >
