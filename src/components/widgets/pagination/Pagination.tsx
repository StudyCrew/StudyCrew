  ...
  return (
    <div className="paginationWidget w-fit flex gap-x-4">
      ...
      <div className="showPage flex">
        <div className="h-[40px] w-[40px] flex justify-center items-center rounded-md bg-white">{page}</div>
        <svg width="23" height="38" viewBox="0 0 23 38" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M8.432 26.116L12.432 12.196H14L10 26.116H8.432Z" fill="#101828" />
        </svg>
        <div className="h-[40px] w-[40px] flex justify-center items-center rounded-md">{totalPages}</div>
      </div>
      <button
