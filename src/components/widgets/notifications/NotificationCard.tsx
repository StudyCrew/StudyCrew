...
const NotificationCard: React.FC<NotificationCardProps> = ({variant, variant1Data, variant2Data, variant3Data}) => {
  return (
    <>
      {variant === "platform" && variant1Data &&
        <div className={`${variant1Data.size==="small"?"w-[280px]":"w-[462px]"} flex flex-col`}>
          <div className="h-[40px] flex bg-[#fcebae] rounded-t-xl">
            ...
            <div className={`${variant1Data.size === "small" ? "w-[240px]" : "w-[422px]"} bg-[#eecc51] flex items-center h-[40px] px-4 py-2 text-[16px] rounded-tr-xl`} style={{boxSizing:"border-box"}}>
              {variant1Data.title}
            </div>
          </div>
      ...
      {variant === "grpQuestion" && variant2Data &&
        <div className={`${variant2Data.size==="small"?"w-[280px]":"w-[462px]"} flex flex-col`}>
          <div className="h-[40px] flex bg-[#64a1ff] rounded-t-xl">
            <div className="flex h-[40px] w-[40px] justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 256 256"><path d="M140,180a12,12,0,1,1-12-12A12,12,0,0,1,140,180ZM128,72c-22.06,0-40,16.15-40,36v4a8,8,0,0,0,16,0v-4c0-11,10.77-20,24-20s24,9,24,20-10.77,20-24,20a8,8,0,0,0-8,8v8a8,8,0,0,0,16,0v-.72c18.24-3.35,32-17.9,32-35.28C168,88.15,150.06,72,128,72Zm104,56A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z"></path></svg>
            </div>
            <div className={`${variant2Data.size === "small" ? "w-[240px]" : "w-[422px]"} bg-[#3a86fd] text-white flex items-center h-[40px] px-4 py-2 text-[16px] rounded-tr-xl line-clamp-1`} style={{boxSizing:"border-box"}}>
              <span className="line-clamp-1">Question in {variant2Data.groupName}</span>
            </div>
          </div>
          <div className="flex bg-white border-b-[1px] border-[#cfd3de]">
            <div className="w-[50%] p-2 flex gap-x-2 items-center line-clamp-1 border-r-[1px] border-[#cfd3de]">
              <img src={variant2Data.img} className="w-[24px] h-[24px] rounded-full" alt="" />
              <span className="line-clamp-1 text-lg font-[500] mt-[3px] text-[14px]">{variant2Data.username}</span>
            </div>
      ...
      {variant === "grpMaterial" && variant3Data &&
        <div className={`${variant3Data.size==="small"?"w-[280px]":"w-[462px]"} flex flex-col`}>
          <div className="h-[40px] flex bg-[#64a1ff] rounded-t-xl">
            <div className="flex h-[40px] w-[40px] justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 256 256"><path d="M213.66,82.34l-56-56A8,8,0,0,0,152,24H56A16,16,0,0,0,40,40V216a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V88A8,8,0,0,0,213.66,82.34ZM160,51.31,188.69,80H160ZM200,216H56V40h88V88a8,8,0,0,0,8,8h48V216Zm-42.34-77.66a8,8,0,0,1-11.32,11.32L136,139.31V184a8,8,0,0,1-16,0V139.31l-10.34,10.35a8,8,0,0,1-11.32-11.32l24-24a8,8,0,0,1,11.32,0Z"></path></svg>
            </div>
            <div className={`${variant3Data.size === "small" ? "w-[240px]" : "w-[422px]"} bg-[#3a86fd] text-white flex items-center h-[40px] px-4 py-2 text-[16px] rounded-tr-xl line-clamp-1`} style={{boxSizing:"border-box"}}>
              <span className="line-clamp-1">Material in {variant3Data.groupName}</span>
            </div>
          </div>
          <div className="flex bg-white border-b-[1px] border-[#cfd3de]">
            <div className="w-[50%] p-2 flex gap-x-2 items-center line-clamp-1 border-r-[1px] border-[#cfd3de]">
              <img src={variant3Data.img} className="w-[24px] h-[24px] rounded-full" alt="" />
              <span className="line-clamp-1 text-lg font-[500] mt-[3px] text-[14px]">{variant3Data.username}</span>
            </div>
            <div className="w-[50%] p-2 text-base flex items-center text-center text-[12px]">
              {variant3Data.date}
            </div>
