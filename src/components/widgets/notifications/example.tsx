  ...
  return (
    <div className="flex flex-col justify-evenly items-center min-h-screen bg-[#e4e7ec] gap-x-4">
      <div className="flex gap-x-4">
        <NotificationCard variant="platform" variant1Data={{ size: "small", content: "hello i am", title: "Hello" }} />
        <NotificationCard variant="platform" variant1Data={{ size: "large", content: "hello i am", title: "Hello" }} />
      </div>
      <div className="flex gap-x-4">
      ...
      <div className="flex gap-x-4">
        <NotificationCard variant="grpMaterial" variant3Data={{
          size: "small",
