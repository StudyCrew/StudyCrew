...
const ChatCard: React.FC<ChatCardProps> = ({ text, profileImageLink, user, otherUser }) => {
  return (
    <>
      {user && (
        ...
        <div className="flex gap-x-2 max-w-[300px] items-start">
          <div className="image">
            <img src={profileImageLink} alt="avatarlink" className="w-[31px] h-[31px] rounded-full" />
          </div>
