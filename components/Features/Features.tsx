...
const Features: React.FC<any> = (): JSX.Element => {
	...
	const [stageActiveCardIndexes, setStageActiveCardIndexes] = useState<number[]>([
		0, 0, 0
	])
	...
	const onNextStageCardClick = useCallback((id: string): void => {
	...
	const onPrevStageCardClick = useCallback((id: string): void => {
		const nextStageActiveCardIndexes = [...stageActiveCardIndexes]
