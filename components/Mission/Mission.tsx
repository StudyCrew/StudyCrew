	...
	return (
      ...
      to be placeholders and might need to be replaced with actual color values. */}
          ...
          104.085V0Z"
			...
			{/* Main content */}
			<div className='bg-gradient-to-r from-primary-500 to-gradient-500 lg:h-85vh h-screen
			max-w-100vw relative flex top-36 px-6 lg:px-36 z-1'>
				...
				xl:text-xl'>
					<div className="flex flex-col">
						<h3 className='mission-header text-zircon-50 pb-4 lg:top-48 relative'>OUR MISSION</h3>
						<h2 className='mission-header text-zircon-50 slogan lg:top-48 relative'>
							We support education for all.</h2>
						<p className='absolute mr-5% top-96 text-white'>
