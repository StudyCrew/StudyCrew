		...
		<div className="hero">
            ...
            The{' '}
					<span className="relative-span">
						<svg aria-hidden="true" viewBox="0 0 418 42" className="blue-wave"
            ...
            of Education is <br />
					<span className="relative-span">
						<svg aria-hidden="true" viewBox="0 0 418 42" className="blue-wave"
							preserveAspectRatio="none"></svg>
						<span className="relative-span heading-font text-transition text-gradient huge-font"
							style={{ opacity }}> {currentWord}</span>
					</span>
				</h1>
