	...
	return (
		<div className="footer">
			...
			<div className="footer-logo">
				{/* SVG Logo */}
				<svg width="75" height="75" viewBox="0 0 446 445" fill="none"
            ...
            103.227 169.703C103.227 143.298 86.4842 120.804 63.0354 112.257C96.0477 45.7293 164.671 0 243.975
            0C277.585 0 309.276 8.21353 337.152 22.7429C328.676 33.2346 323.601 46.5867 323.601
          ...
          StudyCrew
				...
				<button>
					<FaDiscord size={23} color="white" className="discord-logo" />
					<label>
            Join our community
					</label>
				</button>
