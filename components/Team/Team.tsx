...
const Team = (): JSX.Element => {
	...
	const scrollHorizontally = (): void => {
		if (scrollContainer.current) {
			const step = (): void => {
				const scrollContainerCurrent = scrollContainer.current as HTMLDivElement | null
				if (scrollContainerCurrent) {
					scrollContainerCurrent.scrollLeft += 1
				}
				if (scrollContainerCurrent && scrollContainerCurrent.scrollLeft >=
	...
	return (
		<div className="team-component">
			<div className="head-title">
				...
				<p>
          Our team of talented and open-minded individuals makes Study Crew one of the most
          diverse sets of collaborators in the world.
				</p>
			</div>
			<div className="bg">
