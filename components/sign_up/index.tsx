...
const SignUp: React.FC<SignUpProps> = (props: SignUpProps): JSX.Element => {
  ...
  }, [setMessage, setEmail, fetchSpotsLeft])
  ...
  return (
    <div className={classNames(finalClassName, `${CLASS_NAME}-empower`)}>
      <div className={`${CLASS_NAME}-left-wing`}>
        <svg
          width="230"
          height="500"
      ...
      <div className={`blue-neon-mist ${CLASS_NAME}-mist`}></div>
      <div className={`${CLASS_NAME}-user-email`}>
        <h2>
          Empowering <span>You</span>
        </h2>
        <p className={`${CLASS_NAME}-subtitle`}>
        ...
        <div className={`${CLASS_NAME}-email-input`}>
          <input
            type="email"
      ...
      <div className={`${CLASS_NAME}-right-wing`}>
        <svg
          width="230"
          height="500"
